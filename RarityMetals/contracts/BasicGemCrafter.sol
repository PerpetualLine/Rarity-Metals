...
contract BasicMetalCrafter is Ownable {
  ...
  constructor(ProvablyRareGemV3 _metal) {
    METAL = _gem;
    _gem.create('Coal', '#30D5C8', 7**2, 64, 10000, address(this), msg.sender);
    _gem.create('Copper', '#EAE0C8', 7**3, 32, 10001, address(this), msg.sender);
    _gem.create('Tin', '#007082', 7**4, 16, 10005, address(this), msg.sender);
    _gem.create('Iron', '#A3C6C2', 7**5, 8, 10010, address(this), msg.sender);
    _gem.create('Silver', '#FFBF00', 7**6, 4, 10030, address(this), msg.sender);
    _gem.create('Platinum', '#034B03', 7**7, 2, 10100, address(this), msg.sender);
    _gem.create('Mithril', '#7FFFD4', 7**8, 1, 10300, address(this), msg.sender);
    _gem.create('Adamant', '#872282', 7**9, 1, 11000, address(this), msg.sender);
    _gem.create('Rune', '#F26722', 7**10, 1, 13000, address(this), msg.sender);
    _gem.create('Dragon', '#21B54B', 7**11, 1, 20000, address(this), msg.sender);
    _gem.create('Orichalcum', '#1E88B4', 7**12, 1, 30000, address(this), msg.sender);
    _gem.create("Raridium", '#660000', 7**13, 1, 50000, address(this), msg.sender);
  }
  ...
  function create(
    ...
    METAL.create(name, color, difficulty, gemsPerMine, multiplier, address(this), msg.sender);
  }
